  ...
  return (
    <div class="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
            <div class="text-center px-6">
                <h2 class="text-blue-900 text-3xl font-extrabold">Contact Us</h2>
            ...
            <div class="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
                ...
                <div class="bg-blue-900 rounded-lg p-6 h-full max-lg:order-1">
                    ...
                    <ul class="flex flex-wrap gap-4 mt-16">
                        <li class="bg-blue-900 hover:bg-blue-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                        ...
                        <li class="bg-blue-400  h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <a href="javascript:void(0)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#fff'
                                    viewBox="0 0 511 512">
                                    <path
                        ...
                        <li class="bg-pink-500 hover:bg-pink-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <a href="javascript:void(0)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#fff'
                                    viewBox="0 0 24 24">
                                    <path
                ...
                <div class="p-4 lg:col-span-2">
                    <form>
                        ...
                        <button type="button"
                            class="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide text-white bg-green-500 hover:bg-green-700">
